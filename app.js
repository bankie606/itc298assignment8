...
introApp.controller('IntroController', ['$scope', function($scope) {
  ...
  $scope.synths = [
    {id: 0, brand: 'korg', model:'Poly-800', price: 250.00, polyphony: '6 Voices', src:'public/images/poly800.jpg'},
    {id: 1, brand: 'nord', model:'Micro-Modular', price: 400.00, polyphony: 'Variable/ 6 Voices', src: 'public/images/micromodular.png'},
    {id: 2, brand: 'elektron',model:'Monomachine', price: 500.00, polyphony: 'Variable/ 6 Voices', src: 'public/images/monomachine.jpg'},
